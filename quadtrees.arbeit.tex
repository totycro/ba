...
Mit dieser Methode kann weiters garantiert werden, dass eine Pseudo Quadtree aufgebaut werden kann, dessen Höhe garantiert $\lceil \log_{d+1} n\rceil$ nicht überschreitet, wobei $n$ die Anzahl der Daten darstellt.\footzit{Vgl.}{DBLP:journals/acta/OvermarsL82}{Seite 8}
...
Eine konkreter Instanz eines MX Quadtree enthält somit nur schwarze und graue Knoten.
