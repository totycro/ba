...
% Ein konkreten MX Quadtree enthält somit nur schwarze und graue Knoten.
% todo: überleitung
...
%Beim Einfügen eines neuen Knotens wird die Struktur des Baumes entlang des Pfades des Schlüssels gebildet.


% eher ungeeignet bei ganz wenigen daten und großer tiefe

% einfügereihenfolge irrelevant
% -> keine entartung
% determiniert durch a priori raumaufteilung
% -> raum vorher bekannt

% höhe konstant

% löschen: daten nur in blättern

% 2^n
% mx = matrix
% 

% für grafisches entwickelt, wie z.b. hier:
% quadtrees79.pdf   operations on images using quadtrees. hunter and steiglitz
\cite{Samet:1985:SCP:282957.282966}
% später mx genannt -> samet verweis
